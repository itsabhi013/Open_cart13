...
TC1
    ...
    Input Text    id=input-comment     it possible to see the PayPal transaction id? without that, it is very hard to see the information you should be shown with the payment details in the order.
